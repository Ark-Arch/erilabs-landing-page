        ...
        <div className="relative rounded-2xl overflow-hidden">
          <div className="relative z-10 mx-auto text-center max-w-xl md:max-w-2xl py-8 md:py-10 px-6 md:px-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-heading-1">
              ...
              Quick! Optimise your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-600">
               Very Own
              </span> Business
            </h1>
            <Paragraph className="pt-10">
              Leverage our platform platform to revolutionize your industry - what it may be. Get data-driven insights and automation at your
              fingertips.
            </Paragraph>
